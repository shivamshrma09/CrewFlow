  ...
  return (
    <>
      ...
      <div className='min-h-screen flex items-center justify-center p-4'>
        <div className='border border-neutral-500/30 rounded-lg p-6 bg-black max-w-md w-full'>
          ...
          {!otpsend ? (
            <>
              <form onSubmit={(e) => { e.preventDefault(); setotpsend(true); }}>
                <label className='text-sm text-white'>Enter your Name</label>
                <input type='text' required className='w-full bg-black text-white border border-neutral-500/30 rounded-lg px-4 py-2 mt-1 mb-4' />
